...
// Packet - a generic interface
// to combine few protocols func together
type Packet interface {
	Ping(string, string, chan<- []byte) error
	Traceroute(string, string, chan<- []byte) error
	BGP(string, string, chan<- []byte) error
}
